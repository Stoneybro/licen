...
At request time, the contract checks the researcher's requested access against the owner's policy envelope: price, requested epochs, repeat-request caps, access duration, expiry, and allowed purpose IDs.
