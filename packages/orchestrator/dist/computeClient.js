...
let _createZGComputeNetworkBroker = null;
...
async function getBroker() {
    ...
    brokerInstance = await createBroker(wallet);
    return brokerInstance;
}
// ---------------------------------------------------------------------------
...
export async function createFineTuningTask(params) {
    ...
    const result = await broker.fineTuning.createTask(providerAddress, model, params.datasetRootHash, config);
 ...
 */
export async function getTaskStatus(taskId, providerAddress) {
    const broker = await getBroker();
